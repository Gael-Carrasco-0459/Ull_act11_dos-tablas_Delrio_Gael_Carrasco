...
urlpatterns = [
    ...
    path('crear/', views.crear_proveedores, name='crear_proveedor'),
    path('editar/<int:proveedor_id>/', views.editar_proveedor, name='editar_proveedor'),
    path('borrar/<int:proveedor_id>/', views.borrar_proveedores, name='borrar_proveedor'),
]